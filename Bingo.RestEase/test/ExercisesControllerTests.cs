...
namespace Bingo.RestEase.Test
{
    public class ExercisesControllerTest : TestBase
    {
        ...
        public async void GetExercises_WhenDataExists_ReturnsListContainingExpectedExercise200()
        {
            ...
            var response = await _service.ExercisesService.GetExercises();
        ...
        public async void GetExercise_ByExerciseId_ReturnsExpectedExercise200()
        {
            ...
            var response = await _service.ExercisesService.GetExerciseById(expectedExercise.Id);
        ...
        public async void GetActivationsForExercise_ByExerciseId_ReturnsExpectedActivations200()
        {
            ...
            var response = await _service.ExercisesService.GetActivationsForExercise(expectedExercise.Id);
            var actualExercises = response.GetContent();
        ...
        public async void GetActivationForExercise_ByExerciseId_ReturnsExpectedActivation200()
        {
            ...
            var response = await _service.ExercisesService.GetActivationForExercise(expectedExercise.Id, expectedActivation.Id);
        ...
        public async void PostExercise_ByValidDto_ReturnsPostedExercise201()
        {
            ...
            var response = await _service.ExercisesService.PostExercise(postDto);
        ...
        public async void PostActivationToExercise_WithValidRqo_ReturnsPostedExercise201()
        {
            ...
            var response = await _service.ExercisesService.PostActivationToExercise(expectedExercise.Id, postDto);
        ...
        public async void DeleteExercise_ByExerciseId_ReturnsNoData204()
        {
            ...
            var response = await _service.ExercisesService.DeleteExerciseById(exerciseToDelete.Id);
        ...
        public async void DeleteActivationFromExercise_ByIds_ReturnsNoData204()
        {
            ...
            var response = await _service.ExercisesService.DeleteActivationFromExercise(exercise.Id, activationToDelete.Id);
